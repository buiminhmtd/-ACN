...
namespace MovieBooking.Controllers
{
    public class ScreensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "screen_id,screen_number,total_seats")] Screen screen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "screen_id,screen_number,total_seats")] Screen screen)
        {
            if (ModelState.IsValid)
            {
