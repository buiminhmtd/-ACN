...
namespace MovieBooking.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "payment_id,booking_id,payment_date,amount,payment_method,status")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "payment_id,booking_id,payment_date,amount,payment_method,status")] Payment payment)
        {
            if (ModelState.IsValid)
            {
